...
def demo_catalog_with_config_yml(tmp_path):
    ...
    return WebCatalog(location=catalog_path, config_file=str(demo_config_path_yml))

@pytest.fixture
def demo_catalog_with_config_json(tmp_path):
    catalog_path = tmp_path / "demo_catalog_with_config_json"
    return WebCatalog(location=catalog_path, config_file=str(demo_config_path_json))
...
def test_config_with_file_yml(tmp_path, demo_catalog_with_config_yml):
    ...
    assert demo_catalog_with_config_yml.config[CATALOG_NAME] == "DataLad Catalog Config Test"
...
def test_config_with_file_json(tmp_path, demo_catalog_with_config_json):
    ...
    assert demo_catalog_with_config_json.config[CATALOG_NAME] == "DataLad Catalog Config Test"
