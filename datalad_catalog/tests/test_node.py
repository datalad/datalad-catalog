...
def test_node_instances_equal():
    ...
    """
    node_instance_1 = Node(type='dataset', dataset_id='123', dataset_version='v1')
...
def test_node_location_dataset(demo_catalog: WebCatalog, demo_node_dataset: Node):
    ...
    location = metadata_dir / demo_node_dataset.dataset_id / demo_node_dataset.dataset_version\
...
def test_node_location_directory(demo_catalog: WebCatalog, demo_node_directory: Node):
    ...
    metadata_dir = demo_catalog.metadata_path
    location = metadata_dir / demo_node_directory.dataset_id / demo_node_directory.dataset_version\
...
def test_add_child_new(demo_node_directory: Node):
    ...
    assert demo_node_directory.children[0][cnst.TYPE] == test_child_file[cnst.TYPE]
    assert demo_node_directory.children[0][cnst.NAME] == test_child_file[cnst.NAME]
...
def test_add_extractor_new(demo_node_directory: Node):
    ...
    for key in test_extractor:
        assert demo_node_directory.extractors_used[0][key] == test_extractor[key]
